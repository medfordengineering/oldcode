...
status at45_buffer_write(unsigned int byte_address, unsigned char *data, unsigned int size)
{
	unsigned int i = 0;
...
status at45_buffer_read(unsigned int byte_address, unsigned char *data, unsigned int size)
{
	  unsigned int i = 0;
